...
var supported_languages = ["greek", "english", "dutch"];
...
if (lang_check < 0) { UI.ErrorMessage('<font color=gold><b><center><u>' + tsalkapone_trans.general.notification + ' Tsalkapone</u></center></b></font> <br><br> The selected language is not supported. Please select one of the supported languages.', 5000); }
	...
	var tsalkapone_trans = (function () {
		...
		tsalkapone_trans.dutch = {
			general: {
				script: "Tijd & Afstand Calculator",
				notification: "Notificatie forumulier",
				selected_one: "Huidig geselecteerde taal",
				available: "Beschikbare talen",
				button_list: "Knoppen Lijst",
				lang_sel: "Klik om de geselecteerde taal te wijzigen",
				message_no: "Nee",
				message_yes: "Ja",
				message_1: "Dit script is geactiveerd in Overzichten -> Gecombineerd.",
				message_2: "Wil je je locatie automatisch toewijzen aan deze pagina?",
				comm: "Stuur gerust een bericht over scriptbugs of ideeën naar",
				des: "Functiebeschrijving",
				but: "Knoppen",
				edited_by: "Bewerkt door",
				created: "Gecreëerd door",
				set_list: "Instellingen & Functies",
				res_list: "Script Instellingen",
				blank: "Klik op de knop van een script om de instellingen weer te geven",
				script_1: "Bereken de afstand tussen twee dorpen",
				script_2: "Calculate the back-time of a command",
				script_3: "Calculate a snipe time on a back-time command",
				script_4: "Calculate a snipe time on a command",
				script_5: "Open de Time Calculator in een nieuw tabblad",
				script_6: "Bereken de maximale velden die nodig zijn voor elke eenheid voor de selecteerde duur",
				send: "Verzenden",
				vil_from: "Van",
				vil_to: "Naar",
				lau: "[english]on",
				speed: "Eenheidssnelheid",
				amount: "Hoeveelheid",
				ori: "Afkomst",
				dest: "Doel",
				lau_time: "Starttijd",
				list_form: "Snipe Tijden in lijstformaat",
				tab_form: "Snipe Tijden in tabelformaat",
				attention: "[is nog geen goede vertaling] ATTENTIE: Er is waargenomen dat de servertijd die op het scherm wordt weergegeven soms 1 seconde vertraging heeft. Trek in dit geval 1 seconde af van elke keer dat het resultaat wordt weergegeven.",
				vil1: "Dorp van afkomst",
				vil2: "Doeldorp",
				dur: "Duur",
				tsal_apply: "Toepassen",
				tsal_search: "Berekenen",
				spear: "Speervechter",
				sword: "Zwaardvechter",
				axe: "Bijlstrijder",
				archer: "Boogschutter",
				spy: "Verkenner",
				light: "Lichte cavalarie",
				heavy: "Zware cavalarie",
				marcher: "Bereden boodschutter",
				ram: "Ram",
				cats: "Katapult",
				knight: "Ridder",
				snob: "Edelman",
				tsal_time: "Aankomsttijd",
				tsal_target: "Doel",
				tsal_speed: "Eenheid snelheid",
				tsal_unit: "Langzaamste eenheid",
				tsal_dur: "Duur",
				tsal_error: "FOUT",
				tsal_notime: "Geen enkel dorp kan de geselecteerde bestemming bereiken in de gespecificeerde aankomsttijd",
				info1: "Voer de coördinaten in van het dorp van afkomst",
				info2: "Voer de coördinaten in van het doeldorp.",
				info3: "Voer de aankomsttijd van het commando in met vermelding van de maand (de eerste drie letters in het Engels), dag, jaar en tijd (in uur:minuten:seconden) op een 24-uurs schaal",
				info4: "Selecteer het commando die wordt herkend als de langzaamste eenheid. Als je het commando niet correct hebt gelabeld, selecteer je een willekeurige eenheid of geef je de snipe-poging op.",
				info5: "Voor de coördinaten van doeldorp in",
				info6: "Vink een vakje naast een eenheidstype aan om de snelheid op te nemen in de berekening van de snipe tijd. Haal het vinkje weg om dit uit te schakelen",
				info7: "Voer een tijdsduur in, in de volgende vorm: hh:mm:ss (uren:minuten:seconden)",
			},
			buttons: {
				lang_open: "Open taalkeuze",
				lang_close: "Sluit taalkeuze",
				script_1: "Afstand calculator",
				script_2: "Back-Time calculator",
				script_3: "Snipe Back-Time",
				script_4: "Snipe Calculator",
				script_5: "Time Calculator",
				script_6: "Velden Calculator",
				show_results: "Toon Resultaten",
				hide_results: "Verberg Resultaten",
				tsal_info: "Info & Tips",
			},
			notes: {
				activated: "De Tijd en Afstand Calculator script is al actief",
				tsal_notime: "Geen enkel dorp kan het doel binnen de opgegeven aankomsttijd bereiken",
			},
		};
...
function fnInjectOverviewBar() {
	...
	else if (get_lang == "dutch") { document.getElementById('dutch_lang').checked = true; }
	...
	$("#dutch_lang").click(function () {
		localStorage.setItem("time_distance_lang", "dutch");
		location.reload();
	});
